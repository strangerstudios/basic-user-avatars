 			...
 			echo '<fieldset class="bbp-form avatar">';
				...
				if ( empty( $options['basic_user_avatars_caps'] ) || current_user_can( 'upload_files' ) ) {
					...
					if ( empty( $profileuser->basic_user_avatar ) ) {
						...
						echo '<label><input type="checkbox" name="basic-user-avatar-erase" value="1" style="width:auto;margin-right:5px!important;" />' . apply_filters( 'bu_avatars_delete_avatar_text', __( 'Delete local avatar', 'basic-user-avatars' ), $profileuser ) . '</label><br />';
